...
public class CachedCollectionDAO implements CollectionDAO, Cached {
    ...
    private final Map<String, CardCollection> _playerCollections =
    ...
    @Override
    public final CardCollection getPlayerCollection(int playerId, String type) throws SQLException, IOException {
    ...
    private static String constructCacheKey(int playerId, String type) {
        return playerId +"-"+type;
    }

    @Override
    public final Map<Integer, CardCollection> getPlayerCollectionsByType(String type) throws SQLException, IOException {
