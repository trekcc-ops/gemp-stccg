...
public class ConstructedLeagueData implements LeagueData {
    ...
    /*
        Example params - 20120312,test_block,0.7,default,All cards,7,10,3,test2_block,test_block,test3_block,
            test_block,test_block,test_block
        Which means - start date,league prize pool,prizes multiplier,collection type,collection name,
            series length,series match count,series count,
