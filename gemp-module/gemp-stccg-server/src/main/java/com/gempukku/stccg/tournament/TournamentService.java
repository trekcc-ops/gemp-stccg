...
public class TournamentService {
    ...
    public final CardDeck getPlayerDeck(String tournamentId, String player, String format) {
    ...
    public final Tournament addTournament(String tournamentId, String draftType, String tournamentName, String format,
    ...
    public final List<Tournament> getOldTournaments(long since) {
    ...
    public final List<Tournament> getLiveTournaments() {
    ...
    public final Tournament getTournamentById(String tournamentId) {
    ...
    public final void addRoundBye(String tournamentId, String player, int round) {
    ...
    public final void updateScheduledTournamentStarted(String tournamentId) {
        _tournamentDao.updateScheduledTournamentStarted(tournamentId);
    }
}