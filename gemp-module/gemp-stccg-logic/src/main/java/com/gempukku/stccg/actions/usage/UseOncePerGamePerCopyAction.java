...
public class UseOncePerGamePerCopyAction extends ActionyAction {
    private final PhysicalCard _card;
    private final static int LIMIT_PER_GAME = 1;
    private final ActionBlueprint _blueprint;

    public UseOncePerGamePerCopyAction(DefaultGame cardGame, PhysicalCard performingCard,
    ...
    private LimitCounter getLimitCounter(DefaultGame cardGame) {
        return cardGame.getGameState().getPerGamePerCopyLimitCounter(_performingPlayerId, _card, _blueprint);
    }
}