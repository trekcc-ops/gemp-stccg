...
public interface ActionSource {
    ...
    Action createActionWithNewContext(PhysicalCard card, ActionResult actionResult);
    Action createActionWithNewContext(PhysicalCard card, String playerId, ActionResult actionResult);
