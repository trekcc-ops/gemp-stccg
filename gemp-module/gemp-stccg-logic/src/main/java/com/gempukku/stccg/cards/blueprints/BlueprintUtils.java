...
public final class BlueprintUtils {
    ...
    public static FilterableSource getFilterable(JsonNode node, String defaultValue)
        ...
        else return FilterFactory.generateFilter(node.get("filter").textValue());
    }
    ...
    public static ModifierSource getModifier(JsonNode node) throws InvalidCardDefinitionException {
        ...
        final Requirement[] requirements = RequirementFactory.getRequirementsFromJSON(node);
        ...
        switch(modifierType) {
            ...
            case GAINICON:
                ...
                filterableSource = FilterFactory.parseSTCCGFilter(node.get("filter").textValue());
