...
public class RemoveKeyword implements EffectAppenderProducer {
    ...
    public EffectAppender createEffectAppender(JSONObject effectObject, CardBlueprintFactory environment) throws InvalidCardDefinitionException {
        ...
        Keyword keyword = environment.getEnum(Keyword.class, effectObject.get("keyword"), "keyword");
                ...
                new DefaultDelayedAppender() {
                    ...
                    protected Effect createEffect(boolean cost, CostToEffectAction action, ActionContext context) {
                        ...
                        return new AddUntilModifierEffect(context.getGame(),
                                new RemoveKeywordModifier(context.getSource(), Filters.in(cardsFromMemory), keyword), until);
                    }
                });
