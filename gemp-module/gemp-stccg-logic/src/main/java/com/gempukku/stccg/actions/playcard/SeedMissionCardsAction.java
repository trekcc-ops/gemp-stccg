...
public class SeedMissionCardsAction extends AbstractCostToEffectAction {
    ...
    public SeedMissionCardsAction(Player player, ST1EMission mission) {
        super(player, ActionType.OTHER);
        _topCard = mission.getMissionCardForPlayer(player);
        setText("Seed cards under " + _topCard.getFullName());
