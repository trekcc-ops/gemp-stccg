...
describe('jquery-card-details-dialog', () => {
    test('displayCardInfo creates a jQueryUI dialog box', () => {
        ...
        let expected = `<div style=\"scroll: auto\"></div><div class=\"card fullCardDivVertical\" title=\"N'Vek\"><div class=\"three-d-card-scene\"><div class=\"three-d-card\"><div class=\"card__face card__face--back\"><img src=\"test-file-stub\" style=\"width: 100%; height: 100%;\"></div><div class=\"card__face card__face--front\"><div class=\"card-load-spinner\"></div><img class=\"card_img\" style=\"width: 100%; height: 100%;\" alt=\"N'Vek\"><div class=\"borderOverlay\"><img class=\"actionArea\" src=\"test-file-stub\" style=\"width: 100%; height: 100%;\"></div></div></div></div></div>`;
    ...
    test('displayCardInfo creates a jQueryUI dialog box when card is horizontal', () => {
        ...
        cardUnderTest.horizontal = true;
        // TODO: Fill in alt text with title
        let expected = `<div style=\"scroll: auto\"></div><div class=\"card fullCardDivHorizontal\" title=\"N'Vek\"><div class=\"three-d-card-scene\"><div class=\"three-d-card\"><div class=\"card__face card__face--back\"><img src=\"test-file-stub\" style=\"width: 100%; height: 100%;\"></div><div class=\"card__face card__face--front\"><div class=\"card-load-spinner\"></div><img class=\"card_img\" style=\"width: 100%; height: 100%;\" alt=\"N'Vek\"><div class=\"borderOverlay\"><img class=\"actionArea\" src=\"test-file-stub\" style=\"width: 100%; height: 100%;\"></div></div></div></div></div>`;
