...
7. In the main gemp-stccg folder, create the following text files for user/password info. Each file should contain only a single string (no quotes). 
...
8. Open a command line and navigate to the main gemp-stccg folder. 
...
9. The database should have automatically created the tables that are needed.  
...
10. If all has gone as planned, you should now be able to navigate to your own personal instance of Velara.  
   * Open your browser of choice and navigate to http://localhost:17001.
11. If you're presented with the home page, register a new user and log in. If you can log in to the game hall, congrats, you now have a working local version of Velara.
