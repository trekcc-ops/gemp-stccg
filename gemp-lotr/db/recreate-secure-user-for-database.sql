...
#Once you have ran this script, make sure that you alter the credentials used in gemp-stccg-common/.../gemp-lotr.properties, or else the server will crash on startup.
...
# git update-index --assume-unchanged ./gemp-lotr/gemp-stccg-common/src/main/resources/gemp-lotr.properties
