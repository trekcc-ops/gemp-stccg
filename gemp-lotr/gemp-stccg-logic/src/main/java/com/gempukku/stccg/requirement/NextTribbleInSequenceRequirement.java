...
public class NextTribbleInSequenceRequirement extends RequirementProducer{
    @Override
    public Requirement<TribblesActionContext> getPlayRequirement(JSONObject object, CardGenerationEnvironment environment) throws InvalidCardDefinitionException {
