...
public class SeedOutpostEffect extends DefaultEffect {
    ...
    public SeedOutpostEffect(ST1EGame game, Zone playedFrom, PhysicalCard cardPlayed, int spacelineIndex) {
    ...
    public String getText() {
        return "Seed " + GameUtils.getFullName(_cardPlayed);
    }
    ...
    protected FullEffectResult playEffectReturningResult() {
        ...
        _game.getGameState().seedFacilityAtLocation(_cardPlayed, _spacelineIndex);
