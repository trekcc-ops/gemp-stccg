...
public class ActivateMutateTribblePowerEffect extends ActivateTribblePowerEffect {
    public ActivateMutateTribblePowerEffect(CostToEffectAction action, LotroPhysicalCard source) {
        super(action, source);
    }
    ...
    protected FullEffectResult playEffectReturningResult(TribblesGame game) {
        ...
        List<LotroPhysicalCard> playPile = new LinkedList<>(gameState.getPlayPile(_activatingPlayer));
