...
public class OpponentsCantPlayPhaseEventsOrPhaseSpecialAbilitiesModifier extends AbstractModifier {
    ...
    public OpponentsCantPlayPhaseEventsOrPhaseSpecialAbilitiesModifier(LotroPhysicalCard source, String playerId, Phase phase) {
        this(source, null, playerId, phase);
    }

    public OpponentsCantPlayPhaseEventsOrPhaseSpecialAbilitiesModifier(LotroPhysicalCard source, Condition condition, String playerId, Phase phase) {
