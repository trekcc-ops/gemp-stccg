...
public abstract class AddActionToCardModifier extends AbstractModifier {
    public AddActionToCardModifier(LotroPhysicalCard source, Condition condition, Filterable... affectFilter) {
    ...
    protected abstract ActivateCardAction createExtraPhaseAction(DefaultGame game, LotroPhysicalCard matchingCard);
}
